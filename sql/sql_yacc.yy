...
%token                VECINDEX_SYM    1240     /*GrantHe*/
...
table_constraint_def:
        ...
        | VECINDEX_SYM opt_key_or_index opt_ident '(' key_list_with_expression ')' 
          opt_vector_index_options
          {
            $$= NEW_PTN PT_inline_index_definition(@$, KEYTYPE_VECINDEX, $3, nullptr, $5, $7);
          }
...
vector_index_options:
          ...
          {
            $$.init(YYMEM_ROOT);
            if ($$.push_back($1)) MYSQL_YYABORT;
          }
        | vector_index_options vector_index_option
          {
            if ($1.push_back($2)) MYSQL_YYABORT;
            $$= $1;
          }
        ;
